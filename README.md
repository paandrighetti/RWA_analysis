...
[![Framework Version](https://img.shields.io/badge/version-1.0-blue)]() [![Snapshot](https://img.shields.io/badge/snapshot-2026--05--11-green)]() [![Methodology](https://img.shields.io/badge/methodology-open-orange)]()
...
│   ├── scoring_heatmap.png         # 18 criteria × 3 products heatmap
...
2. bIB01 Securities Note dated 8 May 2025 expires 7 May 2026; successor base prospectus status to verify before publication.
3. Empirical snapshot is 2026-05-11; products evolve fast.
...
- Read `01_framework/03_eligibility_matrix.md` for the verdict and reasoning
...
- Use `02_empirical/s4_dune_queries.sql` to run real-time concentration metrics
- Adapt `02_empirical/s4_onchain_analysis.py` for new products
- Track AUM, holder concentration, and transfer activity quarterly

### For bank treasurers
- Use `04_implications/s6_bank_implications.md` as a working framework
...
python 02_empirical/s4_onchain_analysis.py

# Generate the gradient diagram
python 03_gradient/s5_gradient_diagram.py
```

To extract live on-chain data:
1. Open a Dune Analytics account
2. Copy queries from `02_empirical/s4_dune_queries.sql`
...
> Pierre-Antoine Andrighetti. (2026). *RWA HQLA Framework v1.0: A regulatory and empirical assessment of tokenised treasury HQLA eligibility.* https://github.com/paandrighetti/RWA_analysis
