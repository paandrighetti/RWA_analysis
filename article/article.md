...
Within this analytical framework, all three products fail the operational-availability test associated with DR 2015/61 Art. 7(2) because their transfer or control mechanisms can restrict immediate monetisation. BUIDL transfers are restricted to wallets onboarded through Securitize KYC procedures. OUSG transfers are restricted to Ondo Qualified Access Funds onboarded counterparties. bIB01 transfers are subject to a pause function and sanctions blocking, with a freezing function reserved for a future contract upgrade under the Terms and Conditions. These controls may be reasonable or legally required for securities-law compliance. Treating them as impairing immediate operational availability is a framework interpretation; it is not a formal legal or supervisory determination that the assets are legally encumbered.
...
For criterion C.2 (active and sizable market with low concentration under BCBS 238 §24(d)), BUIDL and OUSG fail under the framework, while bIB01 is rated Conditional. BUIDL on Ethereum mainnet has 76 unique holders (of which approximately 25 hold dust balances under $2, leaving ~51 effective holders) and CoinGecko reported zero 24-hour volume on 6 May 2026. The Top-3 holders capture 55% of supply; the Top-25 capture 99.5%. OUSG shows the same pattern at smaller scale. The bIB01 case requires explicit nuance: of its 510 cumulative transfers on Ethereum mainnet, 492 are secondary transfers between holders (96% secondary share), the highest ratio of the three products and a structural distinction from whitelisted fund shares. This is acknowledged in the scoring matrix as a Conditional rather than Fail on C.2. However, in absolute terms, 492 secondary transfers over three years represent approximately 0.43 transfers per day. The observed transfer record does not provide evidence of an active and sizable secondary market, even though the secondary-transfer ratio is high. A token transfer is not necessarily a trade or a change in beneficial ownership, so this metric is treated as an activity proxy rather than a direct measure of trading volume.
...
**L1, UCITS MMF restructuration.** Convert BUIDL from a §3(c)(7)-exempt BVI fund into an EU-authorised UCITS Money Market Fund under Regulation (EU) 2017/1131. The target structure is a Public Debt Constant NAV Short-Term MMF, domiciled in Luxembourg (CSSF) or Ireland (Central Bank of Ireland), with BlackRock Asset Management Ireland Limited or BlackRock (Luxembourg) S.A. as management company, both entities exist and are operational. The depositary role would need to be assigned to an institution eligible under Article 23(2) of Directive 2009/65/EC and applicable national law; the custody arrangements would then be governed by the UCITS depositary framework. This restructuration would unlock potential Level 1 or 2A HQLA treatment via the look-through provision of DR 2015/61 Article 15, subject to the €500 million per-institution cap and supervisory interpretation. The precedent for a public-blockchain-recorded MMF is Franklin Templeton's OnChain US Government Money Fund (BENJI), a regulated 1940 Act fund that invests at least 99.5% of its total assets in government securities, but BENJI operates under US 1940 Act registration, not UCITS, and the EU equivalent does not yet exist. The 12-to-30-month range used here is an illustrative author scenario, not an issuer forecast. Execution would be gated by product design, authorisation and regulatory dialogue on the use of public-blockchain records.
